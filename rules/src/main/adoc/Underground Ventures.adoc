...
:revnumber: W4026
:revdate: 2013-08-27
//:revremark: (Les cartes): Trie monstres par niveau
:doctype: article
:lang: fr
:encoding: utf8
:toc:
...
|| ||1 (2)|| || || || || || |- |Orc || ||1 (3)|| || || || || ||
|- |Squelette || ||1 (1)|| || || || || || |- |Zombie ||
||1 (2)|| || || || || || |- |Goblin || ||2 (4)|| || || || || ||
|- |Momie || ||2 (4)|| || || || || || |-
|Loup-Garou || ||3 (8)|| || || || || || |- |Ogre || ||3
(7)|| || || || || || |- |Sorcière || ||4 (17)|| || || || || ||
|- |Spectre || ||4 (14)|| || || || || || |- |Chevalier
du chaos || ||6 (20)|| || || || || || |- |Golem || ||6
(8/15/23/31)|| || || || || || |- |Nécromant || ||6 (39)|| || ||
|| || || |- |Vampire || ||6 (29)|| || || || || || |}
