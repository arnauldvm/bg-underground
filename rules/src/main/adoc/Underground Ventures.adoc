...
:revnumber: W4025
:revdate: 2013-08-27
//:revremark: (Les cartes): + niveaux des monstres
:doctype: article
:lang: fr
:encoding: utf8
:toc:
...
!!#!!niv!!att!!def!!PV!!con!!esprit!!Spécial |- |Goblin || ||2
(4)|| || || || || || |- |Squelette || ||1 (1)|| || || || || ||
|- |Orc || ||1 (3)|| || || || || || |- |Vampire || ||6
(29)|| || || || || || |- |Araignée géante || ||1 (2)|| || || ||
|| || |- |Loup-Garou || ||3 (8)|| || || || || ||
|- |Chevalier du chaos || ||6 (20)|| || || || || || |-
|Golem || ||6 (8/15/23/31)|| || || || || || |- |Momie || ||2
(4)|| || || || || || |- |Nécromant || ||6 (39)|| || || || || ||
|- |Ogre || ||3 (7)|| || || || || || |- |Sorcière || ||4
(17)|| || || || || || |- |Spectre || ||4 (14)|| || || || || ||
|- |Zombie || ||1 (2)|| || || || || || |}
