...
:revnumber: W4015
:revdate: 2013-07-24
//:revremark: (Phases): Utilisation d'emplacements pour chaque niveau
:doctype: article
:lang: fr
:encoding: utf8
:toc:
...
(par exemple 6), correspondants aux niveaux des cartes. Les cartes sont
...
l'ordre _http://fr.wikipedia.org/wiki/LIFO[LIFO]_.{_em}
...
{minus} voire même jusqu'au dernier niveau.{em}
...
l'exploration du donjon depuis le premier niveau, puisque les premières
cartes auront été éliminées._
...
pas diapo pour donjons building. _(Ne serait-il pas préférable
