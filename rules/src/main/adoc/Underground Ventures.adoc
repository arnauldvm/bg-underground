...
{lcurl}{plus}}=dos bleu)
** {plus} 3 cartes de niveau et/ou escaliers par donjon {plus} 1
carte aventurier ({plus}1 pion) par joueur
* 4 Niveaux, n{plus}1 donjons
...
dans la carte suivante, revenir au village
